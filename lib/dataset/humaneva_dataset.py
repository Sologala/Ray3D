...
humaneva_cameras_extrinsic_params = {
    "S1": [
        {
            "R": [[-0.143362, 0.989627, 0.009217], [0.167173, 0.033395, -0.985362], [-0.975449, -0.139723, -0.170226]],
    ...
    def __init__(self, path, universal=False):
        ...
        for subject in self._cameras:
            ...
            for cam in self._cameras[subject]:
                ...
                for prefix in ["Train/", "Validate/"]:
                    ...
                    camera_info[prefix + subject].append(
                        CameraInfoPacket(
                            P=None,
                            K=K,
                            R=R,
        ...
        for subject, actions in data.items():
            ...
            for action_name, positions in actions.items():
                self._data[subject][action_name] = {"positions": positions}
        if self.universal:
